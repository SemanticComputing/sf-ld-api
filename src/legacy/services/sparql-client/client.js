...
// modified from npm package "sparql-client": "^0.2.0",

var SparqlClient = module.exports = function (endpoint, options, format) {
    if (!format) format = 'application/sparql-results+json';
